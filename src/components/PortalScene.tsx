  ...
  return (
    ...
    >
      ...
      <p
        ref={sinceLabel}
        data-approach
        className="pointer-events-none absolute bottom-[calc(50%_+_23vh_+_1.25rem)] left-1/2 z-30 -translate-x-[38vh] text-[2.5rem] tracking-[0.04em] whitespace-nowrap text-silver-400"
      >
        Since
      </p>
